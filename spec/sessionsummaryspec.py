...
from ops.addons.summary import generate_session_summary
...
def mock_dirs(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("ops.addons.summary.Path", MockPath)

    import ops.addons.summary
    monkeypatch.setattr(ops.addons.summary, "DEFAULT_WORKSPACE", str(tmp_path / "workspace"))
