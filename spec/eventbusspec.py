"""Unit spec for the Asynchronous OS Hardware Event Bus."""
import time
...
def test_configure_thresholds():
    bus = OSEventBus()
    res = bus.configureosevents(cpu_threshold=85.0, poll_interval=10.0)
...
@patch("kernel.events.OSEventBus._check_network")
