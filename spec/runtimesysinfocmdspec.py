...
from kernel.cli import CLI, CommandCompleter

@pytest.fixture
def mock_cli_dependencies():
    with patch("kernel.cli.load_cfg") as mock_cfg, \
         patch("kernel.cli.Agent") as mock_agent, \
         patch("kernel.cli.banner") as mock_banner, \
         patch("kernel.cli.readline") as mock_readline:
...
def test_sysinfo_command(
    ...
    with patch("kernel.cli.logger.info") as mock_logger_info:
