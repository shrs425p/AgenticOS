"""Tests for the ossandboxauditor plugin."""
from unittest.mock import MagicMock, patch
from ops.addons.sandbox import (
...
@patch("kernel.platformio.PlatformAPI.runpowershell")
...
@patch("subprocess.run")
@patch("kernel.platformio.PlatformAPI.runpowershell")
def test_ossandboxauditor_windows(mock_ps_run, mock_run, mock_which, mock_system):
