...
This directory contains the comprehensive, automated test suite for AgenticOS. It features over 440+ unit and integration tests covering the core loop, model clients, security guardrails, filesystem mixins, terminal utilities, and custom plugin architectures.
