"""Unit tests for the AST parser plugin."""
...
from tools.plugins.code_ast_parser import (
    ast_parse_file,
    ast_map_directory
)
...
def test_ast_parse_file(temp_python_file):
    result = ast_parse_file(temp_python_file)
...
def test_ast_map_directory(temp_python_project):
    result = ast_map_directory(temp_python_project)
