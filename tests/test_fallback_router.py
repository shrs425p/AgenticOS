...
from core.model_clients import FallbackRouter, TokenBudgetChecker, build_fallback_router
...
class TestBuildFallbackRouter:
    ...
    def test_build_fallback_router_known_provider_returns_router(self):
        ...
        with patch("core.model_clients.OllamaClient", return_value=mock_fallback_client):
            result = build_fallback_router(cfg, primary)
