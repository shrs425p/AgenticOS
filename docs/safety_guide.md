...
**Best Practice**: Clarity is the key to speed. Be specific about your goals, file types, and desired outputs. (See the [Prompt Engineering Guide](prompt_engineering_guide.md) for more).
