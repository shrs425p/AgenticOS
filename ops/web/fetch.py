...
class FetchMixin:
    @tool(name="fetchurl", desc="Fetch webpage raw content. Args: url", category="Web")
    def fetchurl(self, url: str, timeout: str = "15") -> str:
        """fetchurl function."""
    ...
    @tool(name="getpagetext", desc="Extract readable text from webpage. Args: url", category="Web")
    def getpagetext(self, url: str) -> str:
    ...
    @tool(name="getpagelinks", desc="Extract links from webpage. Args: url", category="Web")
    def getpagelinks(self, url: str) -> str:
    ...
    @tool(name="getpageimages", desc="Extract image URLs from webpage. Args: url", category="Web")
    def getpageimages(self, url: str) -> str:
    ...
    @tool(name="downloadfile", desc="Download file from URL. Args: url, dest_path", category="Web")
    def downloadfile(self, url: str, dest_path: str, timeout: str = "") -> str:
