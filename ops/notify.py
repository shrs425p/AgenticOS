...
class NotificationCenter:
    ...
    @tool(name="setwallpaper", desc="Set desktop wallpaper. Args: image_path or path", category="General")
    def setwallpaper(self, image_path: str = None, path: str = None) -> str:
    ...
    # ── Notifications ─────────────────────────────────────────────────────────
    @tool(name="sendnotification", desc="Send desktop alert. Args: title, message", category="General")
    def sendnotification(self, title: str, message: str) -> str:
...
"""
    ...
    # ── Popups ────────────────────────────────────────────────────────────────
    @tool(name="showpopup", desc="Show popup message box. Args: title, message", category="General")
    def showpopup(self, title: str, message: str) -> str:
