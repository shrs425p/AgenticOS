...
class BulkMixin:
    @tool(name="findlargefiles", desc="Find large files. Args: path, min_mb (optional)", category="Files")
    def findlargefiles(self, path: str, min_mb: str = "10") -> str:
        ...
        try:
            if (
                ...
                return (
                    "Full-drive Python scans are disabled by cfg "
