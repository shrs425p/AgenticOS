...
@tool(name="astparsefile", category="Code", desc="Parse a Python file and return its skeleton (classes, functions, manuals).")
def astparsefile(file_path: str) -> str:
...
@tool(name="astmapdirectory", category="Code", desc="Map the Python AST skeleton of an entire directory.")
def astmapdirectory(dir_path: str) -> str:
