"""Plugin module for unified cross-platform system package manager proclig and installation."""
import platform
import shutil
import subprocess
...
@tool(name="checkpackagemanagers", category="System", desc="Identify available system package managers (e.g. winget, brew, apt) on the host machine.")
def checkpackagemanagers() -> str:
...
@tool(name="installsystempackage", category="System", desc="Autonomously install system utilities (e.g. git, ffmpeg) using the local package manager.")
def installsystempackage(package_name: str) -> str:
