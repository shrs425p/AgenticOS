...
def generate_session_summary() -> str:
    ...
    counts total ops called, unique ops used, errors logged, warnings logged,
    ...
    summary = [
        ...
        "",
        f"- **Total Tools Called**: {total_ops}",
        f"- **Unique Tools Used**: {len(unique_ops)}",
