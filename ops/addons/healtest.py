...
@tool(name="selfhealingtest", desc="Runs daily self-healing spec, validating recovery logic.", category="System")
def selfhealingtest() -> str:
    """Runs daily self-healing spec, validating recovery logic."""
