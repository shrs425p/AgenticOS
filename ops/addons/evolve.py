...
def createplugin(name: str, code: str, description: str = "") -> str:
    """
    Writes a new .py file to ops/addons/ to expand agent capabilities.
    """
    ...
    # Basic Validation
    if "@tool" not in code:
        return "Error: The plugin code must include the '@tool' decorator from 'kernel.registry'."
    ...
    try:
        ...
        return f"SUCCESS: Plugin '{filename}' created in ops/addons/. Hot-reloader will register it in a few seconds. You can then call the new tool."
