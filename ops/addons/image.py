...
@tool(name="imagegetmetadata", category="Image", desc="Get image dimensions, format, mode and EXIF data.")
def imagegetmetadata(image_path: str) -> str:
        ...
        with Image.open(image_path) as img:
            ...
            if exif_data:
                ...
                for tag_id, value in exif_data.items():
                    ...
                    # Exclude huge cliary blobs like MakerNote or UserComment if they are bytes
...
@tool(name="imageconvertformat", category="Image", desc="Convert an image from one format to another (e.g. png to jpg).")
def imageconvertformat(input_path: str, output_path: str) -> str:
...
@tool(name="imageresize", category="Image", desc="Resize an image by width/height or scale percentage.")
def imageresize(input_path: str, output_path: str, width: int = 0, height: int = 0, scale: float = 0.0) -> str:
