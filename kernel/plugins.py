...
class PluginRegistryClient:
    ...
    def __init__(self, registry=None):
        ...
        Args:
            registry: An optional active ToolRegistry instance to register downloaded ops.
        """
    ...
    def download_plugin(self, name: str, registry_url: str) -> str:
        """
        Downloads a plugin, verifies its dependencies, saves it to ops/addons/{name}.py, and registers it.
        ...
        # Write downloaded files to ops/addons/{name}.py
        ...
        full_mod_name = f"ops.addons.{name}"
        try:
            ...
            if spec and spec.loader:
                ...
                if self.registry:
                    self.registry._register_module_ops(module)
            else:
                raise AgentError(
