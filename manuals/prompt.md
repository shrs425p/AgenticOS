...
Remind the agent to use optimized ops for heavy lifting.
-   Prompt: *"Audit my drive. **Use Fast-Path ops** for the search to ensure it runs fast."*
...
> *"Analyze the 'kernel/cli.py' file. Identify any functions that lack docstrings or have high cyclomatic complexity. Propose a refactor for the most complex function but do not apply changes yet."*
...
## Summary
Think of the agent as a highly capable intern. The more context and structure you provide, the less likely it is to make a mistake. By comcliing **Specific Objectives** with **Native-Path Optimization**, you can unlock the full "Hardened" power of AgenticOS.
