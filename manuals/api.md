...
- kernel.cli
- kernel.session_memory

<a id="kernel.registry"></a>
...
<a id="kernel.memory.MemoryManager"></a>
...
<a id="kernel.memory.MemoryManager.register_commitment"></a>
...
<a id="kernel.memory.MemoryManager.get_active_commitments"></a>
...
<a id="kernel.memory.MemoryManager.complete_commitment"></a>
...
<a id="kernel.memory.MemoryManager.get_relevant_context"></a>
...
<a id="kernel.memory.MemoryManager.get_daily_memory_file"></a>
...
<a id="kernel.memory.MemoryManager.log_daily_event"></a>
...
<a id="kernel.memory.MemoryManager.log_task_completion"></a>
...
<a id="kernel.memory.MemoryManager.consolidate_long_term_memory"></a>
...
<a id="kernel.memory.MemoryManager.get_memory_stats"></a>
...
<a id="kernel.memory.MemoryManager.cleanup_old_memories"></a>
...
<a id="kernel.memory.initialize_memory_manager"></a>
...
<a id="kernel.memory.get_memory_manager"></a>
...
<a id="kernel.memory.log_task_completion"></a>
...
<a id="kernel.memory.log_daily_event"></a>
...
<a id="kernel.memory.get_memory_stats"></a>
...
<a id="kernel.memory.consolidate_memory"></a>
...
<a id="kernel.memory.cleanup_old_memories"></a>
...
<a id="kernel.provision"></a>

# kernel.provision

Autonomous Self-Provisioning and Auto-Compiler Engine.

<a id="kernel.provision.refresh_path"></a>
...
<a id="kernel.provision.self_provision_command"></a>
...
- `command_name` _str_ - Name of the command cliary to verify/install.

**Returns**:

- `bool` - True if command is available and wrapper generated, False otherwise.

<a id="kernel.events"></a>
...
completion and serve as a single place to document common cfg keys.
