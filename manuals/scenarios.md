...
You can switch between these scenarios instantly by modifying your `cfg.yaml`. AgenticOS is designed to be "Mode-Agnostic"-your ops, plugins, and workspace artifacts remain consistent regardless of which deployment path you choose.
