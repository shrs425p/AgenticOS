...
- **Solution**: Ensure the Ollama desktop application is active and listening. Verify by visiting `http://localhost:11434` in your browser. If Ollama is running on a different port, update the `ollama.base_url` key in `cfg.yaml`.
...
- **Symptoms**: Native OS window/UI ops raise permission errors.
