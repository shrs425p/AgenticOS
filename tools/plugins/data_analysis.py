...
@tool(name="data_summarize_csv", category="Data", desc="Load a CSV and return its schema and statistical summary.")
def data_summarize_csv(csv_path: str) -> str:
...
@tool(name="data_generate_chart", category="Data", desc="Generate a chart from a CSV file and save it as an image.")
def data_generate_chart(csv_path: str, x_column: str, y_columns: List[str], chart_type: str, output_image: str) -> str:
