...
Plans:
- [ ] 01-01: AST validator and unicode/character cast escape guard.
- [ ] 01-02: Symlink resolution canonicalizer and path traversal block.
- [ ] 01-03: Pydantic configuration schemas and runtime sub-module refactoring.
- [ ] 01-04: Security threat model and test-suite regression coverage.
...
|-------|----------------|--------|-----------|
| 1. Security & Code Quality | 0/4 | Not started | - |
